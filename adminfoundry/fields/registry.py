...
A registry holds an ordered list of :class:`~adminfoundry.fields.base.FieldAdapter`
...
registry is built once in :mod:`adminfoundry.fields.__init__` so tests
...
from adminfoundry.fields.base import FieldAdapter
