...
* Have :func:`adminfoundry.authz.catalog.sync_permission_catalog` merge
...
from adminfoundry.security.validation import validate_permission_key


class PermissionRegistry:
    """Holds permission keys contributed by extensions.

    Use :func:`adminfoundry.security.validation.validate_permission_key`
